...
if __name__ == '__main__':
    ...
    doc.preamble.append(Command('title', 'Translate to English using GPT3.5'))
    ...
    with doc.create(Section('Introduction')):
        ...
        for p in introduction.paragraphs:
            ...
            introduction_en = GPT_trans(introduction_zh)
            temp = introduction_en[0:4]
            if temp=="\n\n":
                introduction_en = introduction_en[4:]
